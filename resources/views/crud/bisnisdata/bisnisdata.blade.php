    ...
    <div class="row layout-top-spacing">
        <div class="col-lg-12">
            <div class="card">
                ...
                <a href="{{Route('bisniscrud.create')}}" class="btn btn-primary btn-sm">Tambah</a>
                    <!-- Modal -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-hover" id="default-ordering">
                                ...
                                <tbody>
                                @foreach($bisniscrud as $key => $value)
                                    <tr>
                                        <td width="1%">{{$key + 1}}</td>
                                        ...
                                        <td class="text-center" style="display: flex; justify-content: center;">
                                            ...
                                            <a href=" {{ route('bisniscrud.show', $value->id) }}" class="btn btn-warning mb-1 mr-1 rounded-circle" data-toggle="tooltip" title='Update'><i class="fas fa-edit"></i></a>

                                            <form action="{{ route('bisniscrud.destroy', $value->id) }}" method="post">
                                                @method('DELETE')
                                                @csrf
