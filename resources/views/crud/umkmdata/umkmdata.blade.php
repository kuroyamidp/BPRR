    ...
    <div class="row layout-top-spacing">
        <div class="col-lg-12">
            <div class="card">
                ...
                <a href="{{Route('umkmcrud.create')}}" class="btn btn-primary btn-sm">Tambah</a>
                    <!-- Modal -->
                                ...
                                @foreach($umkmcrud as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center" style="display: flex; justify-content: center;">
                                            ...
                                            <a href=" {{ route('umkmcrud.show', $value->id) }}" class="btn btn-warning mb-1 mr-1 rounded-circle" data-toggle="tooltip" title='Update'><i class="fas fa-edit"></i></a>

                                            <form action="{{ route('umkmcrud.destroy', $value->id) }}" method="post">
                                                @method('DELETE')
                                                @csrf
